...
export function CopyButton({ value, label }: { value: string; label: string }) {
  ...
  return (
    <button
      type="button"
      onClick={copy}
      className="inline-flex items-center gap-1.5 rounded-md border border-lijn bg-mist px-2.5 py-1.5 text-sm font-medium text-inkt transition-colors hover:bg-lijn/40 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-accent4 focus-visible:ring-offset-2"
